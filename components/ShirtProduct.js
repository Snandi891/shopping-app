...
const ShirtProduct = ({
  ...
  async function createShirt(ev) {
    ...
    if (_id) {
      await axios.put("/api/shirt", { ...data, _id });
  ...
  return (
    <>
      <form onSubmit={createShirt} className="mx-auto max-w-screen-sm ">
